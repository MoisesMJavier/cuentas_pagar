...
class Generar_PDFile extends CI_Controller {
    ...
    function documentos_autorizacion($emp, $cta, $filtro){
        ...
        $solicitud_evento = $this->Solicitudes_cxp->soli($emp, $cta, $filtro);
 
        $html_facturas = '';
        $totpagar = NULL;

        $facturas = $this->Solicitudes_cxp->soli($emp, $cta, $filtro);
           ...
           $html = '<table>
            <tr>
                ...
                <td colspan="2">
                 ...
                 <td><span><br><B>TRANSFERENCIAS</B></span><br>
       ...
       $this->ArchivoBan->updatePagosTxt($emp, $cta, $filtro);
