...
<script>
    ...
    var grafica;
    var ttipo = 'Clientes '; var ta = new Date().getFullYear(); var ass = '';
    ...
    myApp.controller('datos',
        function ($scope, $http) {
            ...
            var request = {
                method: 'get',
                url: 'Estadisticas/get_total_gerente',
                dataType: 'json',
            ...
            $http({
                method: 'get',
                url: 'Estadisticas/get_asesores_bygerente'
        ...
        $scope.exportData = function (data) {
                    ...
                    request = {
                        method: 'POST',
                        url: url + 'Estadisticas/get_repo_gerente'
                        };
                        $http(request)
                        .then(function (jsonData) {
        ...
        $scope.exportData1 = function (data) {
                ...
                if(a == "" || b == "" || c == undefined || d == undefined){
                    ...
                    request = {
                        method: 'POST',
                        url: url + 'Estadisticas/get_repo_gerente1',
                        data: JSON.stringify({tipo : data.etapa, asesor : data.asesor, fecha_ini : data.fecha1, fecha_fin : data.fecha2})
                        };
                        $http(request)
                        .then(function (jsonData) {
