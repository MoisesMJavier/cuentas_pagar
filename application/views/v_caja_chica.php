        ...
        <div class="col-lg-12">
            <div class="box">
                <div class="box-header">
                     <h3>DIRECCIÓN GENERAL CAJA CHICA</h3>
                </div>
                ...
                <table class="table table-responsive table-bordered table-striped table-hover" id="solCajaChica">
                    <thead>
                        <tr>
                            <th></th>
                            <th><i style="cursor: pointer;" class="fa fa-check-square seleccionar_todas text-red" title="Seleccionar todas las cajas chicas."></i></th> <!-- FECHA: 17-DICIEMBRE-2024 | @author Angel Victoriano <programador.analista30@ciudadmaderas.com> -->
...
<script type="text/javascript">
    ...
    $("#solCajaChica").ready( function () {
        ...
        tabla_caja_chica = $('#solCajaChica').DataTable({
            ...
            "order": [[2, 'asc']],
            "ajax": url + "DireccionGeneral/tablaSolCaja"
    ...
    function format ( d ) {
        ...
        $.each( d.solicitudes, function( i, v){ 
            ...
            solicitudes += '<td>'+v.idsolicitud+'</td>'; // @author Efrain Martinez Muñoz creación de columna solicitud 08/08/2024 
