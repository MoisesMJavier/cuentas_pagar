                        ...
                        <form id="formUsuario" name = "formUsuario" ng-submit="ObtenerReporte(datos)" novalidate>
                            <div class="row">
                                ...
                                <div class="col-md-3 form-group">
                                    <label>Etapa</label>
                                    <select name="etapaSelect" class="form-control"  id="etapaSelect" ng-change="change()" ng-model="datos.etapa" ng-options="item.value as item.label for item in etapas" required>
                            ...
                            <div class="row">
                                ...
                                <div id = "tabla" class="col-md-3" ng-model="datos.tabla">
...
<script>
    ...
    var grafica;
    var prueba;
    var ttipo = 'Clientes '; var ta = new Date().getFullYear();
    var texto = ttipo + ta;
    // 
        ...
        function ($scope, $http) {
            ...
            $http(request)
                .then(function (jsonData) {
                    ...
                    //grafica = data.grafica.toBase64Image();
                })
            ...
            $scope.ObtenerReporte = function(data){
                ...
                var c = $scope.formUsuario.etapaSelect.$viewValue;
                    ...
                    if(a == "" || b == "" || c == undefined){
                        ...
                        request = {
                        method: 'POST',
                        url: url + 'Estadisticas/get_chart',
                    ...
                    /*$http({url: url + 'Estadisticas/get_chart', method: "POST", data: JSON.stringify({tipo : data.etapa, fecha_ini : data.fecha1, fecha_fin : data.fecha2}) })
                    .then(function(response) {
                        $scope.CrearGrafica(response.data);        
                    }, 
                    function(response) { 
                    });*/
            ...
            $scope.exportData = function (data) {
                ...
                var c = $scope.formUsuario.etapaSelect.$viewValue;
                    ...
                    if(a == "" || b == "" || c == undefined){
                        ...
                        request = {
                            method: 'POST',
                            url: url + 'Estadisticas/get_repo_asesor',
                            data: JSON.stringify({tipo : data.etapa, fecha_ini : data.fecha1, fecha_fin : data.fecha2})
                            };
                            $http(request)
                            .then(function (jsonData) {
