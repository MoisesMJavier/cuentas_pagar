                ...
                <div class="box">
                    <div class="box-header with-border">
                        <ul class="nav nav-tabs">
                            <li class="col-md-4 text-center active"><a data-toggle="tab" href="#registro"><h4>Alta</h4></a></li>
                            <li class="col-md-4 text-center"><a data-toggle="tab" href="#listado"><h4>Ver prospectos</h4></a></li>
                            <li class="col-md-4 text-center"><a data-toggle="tab" href="#listado2"><h4>Ver clientes</h4></a></li>
                        </ul>
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade active in" id="registro" role="tabpanel" aria-labelledby="nav-registro" > <!-- REGISTRO -->
                                <form name="formUsuario" id="formUsuario" ng-submit="GuardarUsuario(user,false); formUsuario.$setPristine()" class="col-md-10 col-md-offset-1" novalidate>
                                    <br>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-3 form-group has-float-label" show-errors>
                                            <select ng-model="user.nacionalidad" name="nacionalidad" class="form-control" ng-options="item.label for item in data.Nacionalidades" required>
                                                <option disabled value="">Seleccione una nacionalidad</option>
                                            </select>
                                            <label>* Nacionalidad</label>
                                        </div>
                                        <div class="col-md-3 form-group has-float-label" show-errors>
                                            <select ng-model="user.juridica" name="juridica" class="form-control" ng-options="item.label for item in data.Personalidades" ng-change="user.curp='';user.apellidop='';user.apellidom=''" required>
                                                <option disabled value="">Seleccione una personalidad jurídica</option>
                                            </select>                         
                                            <label>* Personalidad jurídica</label>       
                                        </div>
                                        <div class="col-md-3 form-group has-float-label" show-errors>
                                            <input class="form-control text-uppercase" type="text" id="curp" name="curp" placeholder="CURP" ng-model="user.curp" minlength="18" maxlength="18" ng-pattern="patternCurp" ng-readonly="user.juridica.value == 1"/>
                                            <label>CURP</label>
                                        </div>
                                        <div class="col-md-3 form-group has-float-label" show-errors>
                                            <input class="form-control text-uppercase" type="text" name="rfc" ng-model="user.rfc" placeholder="RFC" minlength="{{user.juridica.value == 1 ? 12: 13}}" maxlength="{{user.juridica.value == 1 ? 12: 13}}"  ng-pattern="patternCurp"/>
                                            <label>RFC</label> 
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        <div class="col-md-6 form-group has-float-label" show-errors>
                                            <input class="form-control" type="text" id="nombre" name="nombre" ng-model="user.nombre" placeholder="{{user.juridica.value == 1 ? '* Razón social': '* Nombre(s)'}}" ng-pattern="user.juridica.value == 1 ? patternRazon : patternNombre" minlength="2" maxlength="100" required/>
                                            <label>{{user.juridica.value == 1 ? '* Razón social': '* Nombre(s)'}}</label> 
                                        </div>
                                        <div class="col-md-3 form-group has-float-label" show-errors>
                                            <input class="form-control" type="text" name="apellidop" ng-model="user.apellidop" placeholder="Apellido paterno"  ng-pattern="patternNombre" minlength="2" maxlength="45" ng-readonly="user.juridica.value == 1"  ng-required="user.juridica.value != 1"/>
                                            <label>* Apellido paterno</label>
                                        </div>
                                        <div class="col-md-3 form-group has-float-label" show-errors>
                                            <input class="form-control" type="text" name="apellidom" ng-model="user.apellidom" placeholder="Apellido materno" ng-readonly="user.juridica.value == 1"  ng-pattern="patternNombre" minlength="2" maxlength="45"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 form-group has-float-label" show-errors>
                                            <input class="form-control" type="text" name="telefono2" ng-model="user.telefono2" placeholder="Teléfono (otro)"  minlength="7" maxlength="15" oninput="this.value=this.value.replace(/[^0-9]/g,'');"/>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 form-group has-float-label" show-errors>
                                            <select ng-model="user.lugar" name="lugar" class="form-control" ng-options="item.label for item in data.Lugares" required>
                                            <option disabled value="">Seleccione un lugar prospección</option>
                                            </select>
                                            <label>* Lugar prospección</label>
                                        </div>
                                        <div class="col-md-4 form-group has-float-label" show-errors>
                                            <select ng-model="user.medio" name="medio" class="form-control" ng-options="item.label for item in data.Medios" required>
                                            <option disabled value="">Seleccione un método de prospección</option>
                                            </select>
                                            <label>* Método de prospección</label>
                                        </div>
                                        <div class="col-md-4 form-group has-float-label" show-errors>
                                            <select ng-model="user.territorio" name="territorio" class="form-control" ng-options="item.label for item in data.Territorios" required>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea  class="form-control" type="text" name="observaciones" ng-model="user.observaciones" placeholder="Observaciones" ></textarea >                                            
                                        </div>
                                    </div>
                                    <br>
                                    <br>
                            ...
                            <div class="tab-pane fade" id="listado" role="tabpanel" aria-labelledby="nav-listado" ><!-- TABLAS PROSPECTOS-->
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-12" ng-show="!selected"  ><br><!-- TABLA-->
                                        <table id="TablaProspectos" name="TablaProspectos" datatable="ng" class="table table-striped"  dt-instance="dtInstance" dt-options="dtOptions" dt-columns="dtColumns" dt-column-defs="dtColumnDefs" style="width: 100%;" >
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">
                                                        <input class="form-control" style="width:100% !important;" type="text" ng-model="search.cliente" placeholder="Nombre"/> 
                                                    </th>
                                                    <th class="text-center">
                                                        <input class="form-control" style="width:100% !important;" type="text" ng-model="search.telefono" placeholder="Teléfono"/> 
                                                    </th>
                                                    <th class="text-center">
                                                        <input class="form-control" style="width:100% !important;" type="text" ng-model="search.asesor" placeholder="Asesor"/> 
                                                    </th>
                                                    <th class="text-center">
                                                        <input class="form-control" style="width:100% !important;" type="text" ng-model="search.gerente" placeholder="Gerente"/> 
                                                    </th>
                                                    <th class="text-center" >Estatus</th>
                                                    <th><label style="width:128px !important; color: white;">. </label></th>
                                                </tr>
                                            </thead>
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Teléfono
                                                        <!--input class="form-control" type="text" ng-model="search.telefono" placeholder="Teléfono"/--> 
                                                    </th>
                                                    <th class="text-center">Asesor
