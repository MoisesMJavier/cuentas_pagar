    ...
    <div class="nav-tabs-custom">
        <ul class="nav nav-tabs">
            ...
            <!-- @uthor Efrain Martinez Muñoz | Fecha 27/03/2025 -->
             <!-- Se valida si el usuario logueado se encuentra en la base en el arreglo de la variable rol y si la solictud tiene la etiqueta 6 y adems si la variable tipo_doc no esta vacia enntonces
              entonces se muestra la pestaña docuemnto en la cual permite cargar la imagen-->
              <?php
                if(($datos_solicitud->idetiqueta == 6) && (in_array($this->session->userdata("inicio_sesion")['rol'], explode(',', $datos_solicitud->rol)) ? 'true' : 'false') && (!isset($datos_solicitud->tipo_doc))){
            ?>
    ...
    <div class="tab-content">
        <div id="info" class="tab-pane fade <?= $notificacion == 0 ? 'in active' : '' ?>">
            ...
            <div class="col-lg-12">
                ...
                <div class="col-lg-12"> <!-- INICIO FECHA: 29-ABRIL-2025 | @author Angel Victoriano <programador.analista30@ciudadmaderas.com> -->
                    <h5 class="text-justify"><b>REF. LOTE:</b> <?= (isset($datos_solicitud->referencia) ? $datos_solicitud->referencia : '--') ?>
                </div> <!-- FIN FECHA: 29-ABRIL-2025 | @author Angel Victoriano <programador.analista30@ciudadmaderas.com> -->
                <div class="col-lg-12">
        ...
        <div id="docs" class="tab-pane fade ">
            <div class="row">
                ...
                <!-- @uthor Efrain Martinez Muñoz | Fecha : 27/03/2025 -->
                <!-- Se crea el espacio donde se podra cargar la imagen de l estatus del lote -->
        ...
        <div id="docs_desc" class="tab-pane fade ">
            <div class="row">
                <div class="col-lg-12">
                    <input type="hidden" id="idsolicitud" name="idsolicitud" value='<?php echo $idsolicitud; ?>'>
                    <div class="row">
                        <div class="col-lg-12" id="descargar_all">
                    ...
                    <div class="row">
                     ...
                     <!-- @uthor Efrain Martinez Muñoz | Fecha : 27/03/2025 -->
                     <!-- Se crea los espacios en los cuales se mostrara la imagen del estatus del lote si es que la solicitud tiene imagen -->
                     <div class="row">
...
<script>
     ...
     * Se agrega la funcion documentos() al $(document).ready(function() para que se cargue al abrir la vista.
     */
    ...
    /**
     * @uthor Efrain Martinez Muñoz | Fecha : 27/03/2025
     * funcion que permite mostrar el espacio para cargar una imagen.
     */
    function documentos() {
    ...
    function descarga_dosc() {
        ...
        $('#descargaImagen').html('');
        arra = [];
        $.post(url + "Devoluciones_Traspasos/descargar_docs", {
            idsolicitud: <?= $idsolicitud ?>
        }).done(function(data) {
            data = JSON.parse(data);
            //  varjson["data"] = array();
            ...
            if (data != '') {
                ...
                $.each(data, function(i, value) {
                    ...
                    // $("#descarga_doc").append("<div class='col-lg-9'><h5>" + (i + 1) + ".- " + value.documento + "</h5></div><div class='col-lg-3'><div class='btn-group' role='group' aria-label='Basic example'> <a href='" + value.ruta + "' class='btn btn-sm btn-primary archivos'><i class='fas fa-download'></i></a></div> </div>");
                    contDocumentos += 1;
                    $("#descarga_doc").append(`
                        <div class='col-lg-8'>
        ...
        if (tipo_doc === 9) {
            ...
            var html = "<div class='col-lg-8'><h5> " + contDocumentos + ".- Estatus lote. </h5></div>" +
                "<div class='col-lg-4'>" +
                    "<div class='btn-group' role='group' aria-label='Basic example'>" +
                        "<button title='Ver imagen' data-url='" + imageUrl + "' onclick='verImagen(this)' class='btn btn-sm btn-primary' id='verIma'>" +
                            "<i class='fas fa-eye'></i>" +
                        "</button>" +
    ...
    function verDocumento(button) {
        ...
        */
        //Oculta el boton de Ver docuemento y muestra el boton de cerrar documento
    ...
    function zomMovImagen(imgElement) {
        ...
        let isDragging = false; // Estado de arrastre (true si se esta arrastrando)
        let startX, startY; // Coordenadas donde inicia el arrastre
        let currentX = 0, currentY = 0; // Posición actual del desplazamiento

        const contenedor = imgElement.parentElement; // Se asume que la imagen esta centrada dentro de un ocntenedor
        ...
        // Aplica la transformación de escala y posisción a la imagen
        ...
        contenedor.addEventListener('wheel', (e) => {
            ...
            scale = Math.min(Math.max(1, scale + delta), 8); // Limite el zoom entre 1x y 8x
            ...
            // Despues de 400ms sin hacer zoom, cambia el cursor a "grab" si no se esta arrastrando
        ...
        document.addEventListener('mousemove', (e) => {
            ...
            setTransform(); // Aplica la trasformación
        });
...
function verImagen(button) {
    ...
    //Función para previzualizar la imagen
    ...
    //Función para guardar la nueva imagen cargada
    ...
    // $('#descargar_todo').on('click', function() {
    //     console.log(arra);
    //     $('.archivos').click();
    // });
        ...
        switch (periodo) {
                ...
                case 8:
                    for (let numPago = 1; numPago <= parcialidades; numPago++) {
                        ...
                        // if (fechaProxPag.isoWeekday() > 5) {
                        //     fechaProxPag.add(1, 'weeks').startOf('isoWeek');
                        // }
                        // if (fechaProxPag.day() === 6) {
                        //     fechaProxPag = fechaInicio.clone().add(2, 'days');
                        // }else if(fechaProxPag.day() === 0){
                        //     fechaProxPag = fechaInicio.clone().add(1, 'days');
                        // }
                    }
                    break;
                case 1:
        ...
        if (fileInput.files.length > 0) {
            ...
            if (tipoImagen === "image/jpeg" || tipoImagen === "image/png") {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.status === "success") {
                            $('.nav-tabs a[href="#facturas_activas"]').tab('show').trigger("click");
                            $('#imagen_lote').hide();
                        } else {
